    ...
    class admin_folder_Redux_Framework_config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'heading'   => __('Enter Social follow links here.', 'redux-framework-demo'),
                'desc'      => __('<p class="description">These will be applied to the social icons in the footer.</p>', 'redux-framework-demo'),
                'fields'    => array(
                    array(
                        ...
                        'desc'      => __('Enter the URL for your Facebook page.', 'redux-framework-demo'),
                        'validate'  => 'url',
                        'default'   => '',
                        'text_hint' => array(
                            'title'     => '',
                    ...
                    array(
                        ...
                        'subtitle'  => __('This must be a URL.', 'redux-framework-demo'),
                        'desc'      => __('Enter the URL for your Pinterest page.', 'redux-framework-demo'),
                        'validate'  => 'url',
                        'default'   => '',
                        'text_hint' => array(
                            'title'     => '',
                    ...
                    array(
                        'id'        => 'opt-text-url-instagram',
                        'type'      => 'text',
                        'title'     => __('Instagram', 'redux-framework-demo'),
                        'subtitle'  => __('This must be a URL.', 'redux-framework-demo'),
                        'desc'      => __('Enter the URL for your Instagram profile.', 'redux-framework-demo'),
                        'validate'  => 'url',
                        'default'   => '',
                        'text_hint' => array(
                            'title'     => '',
        ...
        public function setArguments() {
            ...
            $this->args = array(
                'opt_name' => 'redux_es',
                'display_name' => 'elsa+sam Theme Options',
                'page_slug' => 'elsasam_options',
                'page_title' => 'elsa+sam Theme Options',
                'update_notice' => true,
                'admin_bar' => true,
                'menu_type' => 'submenu',
                'menu_title' => 'elsa+sam Options',
                'allow_sub_menu' => true,
                'page_parent' => 'options-general.php',
                'page_parent_post_type' => 'your_post_type',
                'default_show' => true,
                'default_mark' => '*',
                'google_api_key' => 'AIzaSyDucEdyWWvA84t6GFDvtH_DFsUxjiB-ejE',
                'hints' => 
                array(
